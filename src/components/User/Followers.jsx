      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 p-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gray-800 border border-gray-700 rounded-3xl p-12 shadow-2xl backdrop-blur-md text-center">
            ...
            <p className="text-gray-300 text-lg">Loading followers...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {followers.length === 0 ? (
          <div className="bg-gray-800 border border-gray-700 rounded-3xl p-12 shadow-2xl backdrop-blur-md text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-300 mb-2">No followers yet</h3>
                  ...
                  <div className="flex items-center gap-4 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <Link
                          to={`/user/${f.username}`}
                          className="font-semibold text-gray-100 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-cyan-400 group-hover:to-blue-400 group-hover:bg-clip-text transition-all duration-300 truncate"
                        >
                          @{f.username}
                        </Link>
                        {f.isVerified && (
